...
if node['minecraft']['mark2']['flavor']
  ...
  node.override['minecraft']['mark2']['properties']['mark2']['jar-path'] = '*.jar'
  mark2_jar = "#{node['minecraft']['install_dir']}/#{node['minecraft']['mark2']['flavor']}.jar"
